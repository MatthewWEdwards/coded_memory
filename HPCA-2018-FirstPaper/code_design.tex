...
This code design is motivated from the concept of batch codes~\cite{batchcodes} which enable parallel access to the content stored in a large scale distributed storage system.
