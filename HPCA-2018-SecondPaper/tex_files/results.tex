...
\begin{figure}[h!]
		...
		\caption{The performance of the proposed coded system on the trace pictured in Figure~\ref{fig:vips_ramp}\Matt{TODO: This image should be replaced with one for a simulation that uses a large dynamic coding region}}
