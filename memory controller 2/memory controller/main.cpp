...
extern long double tollcritical_time;
extern int tollcritical_count;
...
int sc_main(int argc, char* argv[]){
	...
	/************IN TOTAL**********************/
	cout << "critical latency(ns)" <<'\t'<< (tollcritical_time + localcritical_time) / (tollcritical_count + localcritical_count) << endl;
	cout << "transactional latency(ns)" << '\t' << (tolltransactional_time + localtransactional_time) / (tolltransactional_count + localtransactional_count) << endl;

	cout << "write latency" << '\t' << (tollwrite_time + localwrite_time) / (tollwrite_count + localwrite_count)+3 << endl;
	return 0;
}